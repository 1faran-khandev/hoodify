    ...
    <section id="about" className="bg-black text-white py-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl leading-relaxed text-gray-300 max-w-3xl mx-auto">
          At <span className="font-bold text-white">Hoodify</span>, we don't just make hoodies — we craft performance-driven streetwear made for movement, comfort, and bold expression. Built for <span className="font-semibold text-white">everyday athletes</span>, creators, and rebels who move with intent.
        </p>
